...
if __name__ == "__main__":
    ...
    inputs = get_input_sequence().unsqueeze(0)      # (1, seq_len, embed_dim)
    ...
    context_vec = mha(inputs)
    print("Input shape:            ", tuple(inputs.shape))
    print("Context vector shape:   ", tuple(context_vec.shape))
    print("num_heads * head_dim:   ", mha.num_heads, '*', mha.head_dim)
    print("First 3 context vectors:\n", context_vec[0, :3])